        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-gray-800 leading-tight">
                    {{ __('Register New Boat') }}
                </h2>
                <p class="text-sm text-gray-500 mt-1">
                    {{ __('Add a new raft to your fleet database.') }}
                </p>
            </div>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border border-gray-100">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            {{ __('Please provide accurate details for the verification system.') }}
                        </p>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-input id="boat_dept_id" class="block mt-1 w-full" type="text" name="boat_dept_id" :value="old('boat_dept_id')" placeholder="e.g. BT-101" autofocus />
                                    <x-input-error for="boat_dept_id" class="mt-2" />
                                </div>

                                <div>
                                    <x-label for="owner_name" value="{{ __('Owner Name') }}" />
                                    <x-input id="owner_name" class="block mt-1 w-full" type="text" name="owner_name" :value="old('owner_name')" placeholder="Full Name" />
                                    <x-input-error for="owner_name" class="mt-2" />
                                </div>

                                <div>
                                    <x-label for="owner_mobile" value="{{ __('Owner Mobile') }}" />
                                    <x-input id="owner_mobile" class="block mt-1 w-full" type="text" name="owner_mobile" :value="old('owner_mobile')" placeholder="10-digit number" />
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-input id="capacity" class="block mt-1 w-full" type="number" name="capacity" :value="old('capacity', 6)" />
                                ...
                                <div>
                                    ...
                                    <div id="image-preview" class="mt-4 hidden relative">
                                        ...
                                        <img src="" class="h-40 w-full object-cover rounded-md shadow-sm border border-gray-200">
                                    </div>
                                </div>
                            </div>
                        </div>
